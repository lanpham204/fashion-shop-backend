...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("SELECT o FROM orders o WHERE " +
            ...
            "OR o.note LIKE %:keyword%) order by o.id desc ")
    Page<Order> searchOrderByKeyword(@Param("keyword") String keyword, Pageable pageable);
    ...
    List<Object> statisticalEarningByMonth(@Param("month") String month);
